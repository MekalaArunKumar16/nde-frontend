...
const Hero = () => {
    return (
        <div className="relative bg-background-SpotNow pt-20">
            ...
            <div className="relative z-10 pt-[120px] max-lg:pt-[100px] mx-4 md:mx-10">
                <div className="flex flex-col lg:flex-row justify-between items-center ml-[82px] mr-[4vw] gap-10 max-2xl:gap-10 max-xl:mr-0 max-2xl:ml-6 max-2xl:mr-0">
                    <div className="flex flex-col gap-5 max-md:gap-4 items-center lg:items-start text-center lg:text-left">
                        {/* Heading */}
                        <h1 className="text-[68px] leading-tight   tracking-tighter  max-md:text-2xl  max-2xl:text-[48px] max-xl:text-[38px] font-roboto  text-home-heading font-800">
                    ...
                    {/* Video Placeholder */}
                    <div className="aspect-[1.6/1]  w-[45vw] max-lg:w-full ">
                        <Image src={IMAGES.spotIcon} alt="hero" /></div>
                </div>
            </div>
